...
- 难查询才进多步循环
- 分类器成本约 **5-15ms/查询**，比简单路径省下的 3-8 秒便宜得多

数据显示典型产品聊天里 **60-80% 是查找型查询**，20-40% 是推理型。Adaptive 路由能把**平均成本砍 30-50%**——这就是 Agentic RAG 经济上成立的关键。
...
- **混合难度的产品聊天**：Adaptive RAG 最优——分类器省下 30-50% 成本
...
::: tip
给团队的第一条建议永远是：**先做 Adaptive 路由，让 60-80% 的简单查询根本不进循环**。这既保住 Agentic 在难查询上的质量优势，又让 10 倍的成本系数在整体上不至于失控——不然你优化的那点精度，全被账单吃回去了。
:::
