---
title: "安全攻防研究 | Web安全 内网渗透 红蓝对抗实战"
...
- **🔥 [BlueMoon 漏洞链深度拆解：四个间谍组织共用的 Chrome+Windows 零日武器库](/security/offensive/bluemoon-exploit-kit-chrome-windows-zero-day-chain-2026) - 2026-09-20 ⭐ CVE-2026-85046/87491/85880 三链合一 / 四个 APT 共用同一套代码 / patch-gap 武器化 / AI 辅助开发迹象**
- [CVE-2026-85046 深度分析：Chrome V8 类型混淆零日，2026 年第六个在野利用的浏览器漏洞](/security/offensive/cve-2026-85046-chrome-v8-type-confusion-zero-day-2026) - 2026-09-07 CVSS 8.8 / V8 类型混淆 CWE-843 / PACKED_ELEMENTS→SMI map 混淆 / Maglev+TurboFan / CISA KEV 9-04 / 第六个 0-day
...
- [当 AI 编程助手变成攻击面：CLI Agent .git 配置供应链攻击剖析与防护](/security/offensive/ai-coding-agent-git-config-supply-chain-attack-2026) - 2026-09-05 7 款主流 Agent 8 个漏洞 / 恶意 .git 配置 RCE / 红队复现 / 防护清单
- [Redis CVE-2026-81934 深度分析：TLS 握手中的 Use-After-Free 与未认证 RCE](/security/offensive/redis-cve-2026-81934-tls-use-after-free-rce-2026) - 2026-09-05 CVSS 7.5 / tlsProcessPendingData() UAF / 未认证任意代码执行 / 补丁 diff / 自查脚本
