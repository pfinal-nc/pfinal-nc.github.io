import{_ as a,c as n,o as p,a6 as e}from"./chunks/framework.BwtyjzPT.js";const u=JSON.parse('{"title":"Python-Faker 完整使用指南 - 如何集成并掌握核心功能","description":"Faker库常用函数","frontmatter":{"title":"Python-Faker 完整使用指南 - 如何集成并掌握核心功能","date":"2023-04-05T22:10:20.000Z","tags":["python"],"description":"Faker库常用函数","author":"PFinal南丞","keywords":["Python Faker库","Faker生成测试数据","Python测试数据生成","Faker库使用指南","Python模拟数据","Faker常用函数","Python数据生成工具","测试数据生成库","Python Faker教程","伪数据生成"],"head":[["link",{"rel":"canonical","href":"https://friday-go.icu/dev/backend/python/Python-Faker库常用函数"}],["meta",{"name":"keywords","content":"Python Faker库,Faker生成测试数据,Python测试数据生成,Faker库使用指南,Python模拟数据,Faker常用函数,Python数据生成工具,测试数据生成库,Python Faker教程,伪数据生成, PFinalClub, Golang教程, Go后端开发, Go微服务, PHP, Python, 技术博客"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"TechArticle\\",\\"headline\\":\\"Python-Faker 完整使用指南 - 如何集成并掌握核心功能\\",\\"url\\":\\"https://friday-go.icu/dev/backend/python/Python-Faker库常用函数\\",\\"datePublished\\":\\"2023-04-05T22:10:20.000Z\\",\\"dateModified\\":1765850732000,\\"author\\":{\\"@type\\":\\"Person\\",\\"name\\":\\"PFinal南丞\\",\\"url\\":\\"https://friday-go.icu/about\\"},\\"publisher\\":{\\"@type\\":\\"Organization\\",\\"name\\":\\"PFinalClub\\",\\"logo\\":{\\"@type\\":\\"ImageObject\\",\\"url\\":\\"https://friday-go.icu/logo.png\\"}},\\"description\\":\\"Faker库常用函数\\",\\"inLanguage\\":\\"zh-CN\\",\\"mainEntityOfPage\\":{\\"@type\\":\\"WebPage\\",\\"@id\\":\\"https://friday-go.icu/dev/backend/python/Python-Faker库常用函数\\"},\\"keywords\\":[\\"Python Faker库\\",\\"Faker生成测试数据\\",\\"Python测试数据生成\\",\\"Faker库使用指南\\",\\"Python模拟数据\\",\\"Faker常用函数\\",\\"Python数据生成工具\\",\\"测试数据生成库\\",\\"Python Faker教程\\",\\"伪数据生成\\"]}"]]},"headers":[],"relativePath":"dev/backend/python/Python-Faker库常用函数.md","filePath":"dev/backend/python/Python-Faker库常用函数.md","lastUpdated":1765850732000}'),l={name:"dev/backend/python/Python-Faker库常用函数.md"};function i(t,s,c,o,r,d){return p(),n("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1680732620000"},s[0]||(s[0]=[e(`<h1 id="python-faker库常用函数" tabindex="-1">Python-Faker库常用函数 <a class="header-anchor" href="#python-faker库常用函数" aria-label="Permalink to &quot;Python-Faker库常用函数&quot;">​</a></h1><h2 id="faker" tabindex="-1">Faker <a class="header-anchor" href="#faker" aria-label="Permalink to &quot;Faker&quot;">​</a></h2><p>Faker是一个Python包，主要用来创建伪数据，使用Faker包，无需再手动生成或者手写随机数来生成数据，只需要调用Faker提供的方法，即可完成数据的生成</p><h4 id="常见的语言代号" tabindex="-1">常见的语言代号： <a class="header-anchor" href="#常见的语言代号" aria-label="Permalink to &quot;常见的语言代号：&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>简体中文：zh_CN</span></span>
