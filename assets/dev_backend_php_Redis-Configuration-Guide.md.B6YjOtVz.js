import{_ as n,o as a,c as e,ad as p}from"./chunks/framework.BWnoZFAA.js";const m=JSON.parse('{"title":"PHP Redis 配置详解 - 缓存与会话管理实战","description":"学习Redis配置文件","frontmatter":{"title":"PHP Redis 配置详解 - 缓存与会话管理实战","date":"2020-06-09T11:31:32.000Z","tags":["Redis"],"description":"学习Redis配置文件","keywords":["Redis配置文件详解","数据库","redis"],"author":"PFinal南丞","recommend":"后端工程","faq":[{"question":"Redis 配置文件主要配置项有哪些？","answer":"常用包括 daemonize、port、bind、timeout、loglevel、databases、maxmemory、持久化（RDB/AOF）相关项、安全 requirepass 等，按部署方式与内存限制调整。"},{"question":"Redis 如何设置内存上限？","answer":"在配置文件中设置 maxmemory，建议为物理内存的约 70%～80%；可配合 maxmemory-policy 设置淘汰策略（如 allkeys-lru、volatile-lru）。"},{"question":"Redis 持久化 RDB 和 AOF 怎么选？","answer":"RDB 定时快照、恢复快但可能丢最近数据；AOF 记录每条写命令、可配 fsync 策略，更安全但文件更大。生产常同时开启，或主 RDB 从 AOF。"}],"head":[["link",{"rel":"canonical","href":"https://friday-go.icu/dev/backend/php/Redis-Configuration-Guide"}],["meta",{"name":"keywords","content":"Redis配置文件详解,数据库,redis, PFinalClub, Golang教程, Go后端开发, Go微服务, PHP, Python, 技术博客"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"TechArticle\\",\\"headline\\":\\"PHP Redis 配置详解 - 缓存与会话管理实战\\",\\"url\\":\\"https://friday-go.icu/dev/backend/php/Redis-Configuration-Guide\\",\\"datePublished\\":\\"2020-06-09T11:31:32.000Z\\",\\"dateModified\\":1776223012000,\\"author\\":{\\"@type\\":\\"Person\\",\\"name\\":\\"PFinal南丞\\",\\"url\\":\\"https://friday-go.icu/about\\"},\\"publisher\\":{\\"@type\\":\\"Organization\\",\\"name\\":\\"PFinalClub\\",\\"logo\\":{\\"@type\\":\\"ImageObject\\",\\"url\\":\\"https://friday-go.icu/logo.png\\"}},\\"description\\":\\"学习Redis配置文件\\",\\"inLanguage\\":\\"zh-CN\\",\\"mainEntityOfPage\\":{\\"@type\\":\\"WebPage\\",\\"@id\\":\\"https://friday-go.icu/dev/backend/php/Redis-Configuration-Guide\\"},\\"keywords\\":[\\"Redis配置文件详解\\",\\"数据库\\",\\"redis\\"]}"],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"BreadcrumbList\\",\\"itemListElement\\":[{\\"@type\\":\\"ListItem\\",\\"position\\":1,\\"name\\":\\"首页\\",\\"item\\":{\\"@id\\":\\"https://friday-go.icu\\",\\"@type\\":\\"WebPage\\"}},{\\"@type\\":\\"ListItem\\",\\"position\\":2,\\"name\\":\\"开发与系统\\",\\"item\\":{\\"@id\\":\\"https://friday-go.icu/dev\\",\\"@type\\":\\"WebPage\\"}},{\\"@type\\":\\"ListItem\\",\\"position\\":3,\\"name\\":\\"后端\\",\\"item\\":{\\"@id\\":\\"https://friday-go.icu/dev/backend\\",\\"@type\\":\\"WebPage\\"}},{\\"@type\\":\\"ListItem\\",\\"position\\":4,\\"name\\":\\"PHP\\",\\"item\\":{\\"@id\\":\\"https://friday-go.icu/dev/backend/php\\",\\"@type\\":\\"WebPage\\"}},{\\"@type\\":\\"ListItem\\",\\"position\\":5,\\"name\\":\\"PHP Redis 配置详解 - 缓存与会话管理实战\\",\\"item\\":{\\"@id\\":\\"https://friday-go.icu/dev/backend/php/Redis-Configuration-Guide\\",\\"@type\\":\\"Article\\"}}]}"],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"FAQPage\\",\\"mainEntity\\":[{\\"@type\\":\\"Question\\",\\"name\\":\\"Redis 配置文件主要配置项有哪些？\\",\\"acceptedAnswer\\":{\\"@type\\":\\"Answer\\",\\"text\\":\\"常用包括 daemonize、port、bind、timeout、loglevel、databases、maxmemory、持久化（RDB/AOF）相关项、安全 requirepass 等，按部署方式与内存限制调整。\\"}},{\\"@type\\":\\"Question\\",\\"name\\":\\"Redis 如何设置内存上限？\\",\\"acceptedAnswer\\":{\\"@type\\":\\"Answer\\",\\"text\\":\\"在配置文件中设置 maxmemory，建议为物理内存的约 70%～80%；可配合 maxmemory-policy 设置淘汰策略（如 allkeys-lru、volatile-lru）。\\"}},{\\"@type\\":\\"Question\\",\\"name\\":\\"Redis 持久化 RDB 和 AOF 怎么选？\\",\\"acceptedAnswer\\":{\\"@type\\":\\"Answer\\",\\"text\\":\\"RDB 定时快照、恢复快但可能丢最近数据；AOF 记录每条写命令、可配 fsync 策略，更安全但文件更大。生产常同时开启，或主 RDB 从 AOF。\\"}}]}"]]},"headers":[],"relativePath":"dev/backend/php/Redis-Configuration-Guide.md","filePath":"dev/backend/php/Redis-Configuration-Guide.md","lastUpdated":1776223012000}'),l={name:"dev/backend/php/Redis-Configuration-Guide.md"};function i(t,s,o,c,r,d){return a(),e("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1591702292000"},s[0]||(s[0]=[p(`<h1 id="redis配置文件详解" tabindex="-1">Redis配置文件详解 <a class="header-anchor" href="#redis配置文件详解" aria-label="Permalink to &quot;Redis配置文件详解&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># Redis配置文件样例</span></span>
