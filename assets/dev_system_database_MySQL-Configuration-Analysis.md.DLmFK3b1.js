import{_ as n,c as a,o as p,a6 as l}from"./chunks/framework.BwtyjzPT.js";const m=JSON.parse('{"title":"MySQL配置文件解析 - 完整使用指南","description":"详细介绍MySQL配置文件的解析，包括配置文件的位置、常用配置项、优化建议等，帮助开发者更好地管理和优化MySQL数据库。","frontmatter":{"title":"MySQL配置文件解析 - 完整使用指南","date":"2022-04-09T11:31:32.000Z","tags":["MySQL"],"description":"详细介绍MySQL配置文件的解析，包括配置文件的位置、常用配置项、优化建议等，帮助开发者更好地管理和优化MySQL数据库。","author":"PFinal南丞","keywords":"MySQL, 配置文件, 解析, 优化, 数据库, 配置, 管理, 优化建议, 配置文件解析, MySQL配置文件, MySQL配置","head":[["link",{"rel":"canonical","href":"https://friday-go.icu/dev/system/database/MySQL-Configuration-Analysis"}],["meta",{"name":"keywords","content":"MySQL, 配置文件, 解析, 优化, 数据库, 配置, 管理, 优化建议, 配置文件解析, MySQL配置文件, MySQL配置, PFinalClub, Golang教程, Go后端开发, Go微服务, PHP, Python, 技术博客"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"TechArticle\\",\\"headline\\":\\"MySQL配置文件解析 - 完整使用指南\\",\\"url\\":\\"https://friday-go.icu/dev/system/database/MySQL-Configuration-Analysis\\",\\"datePublished\\":\\"2022-04-09T11:31:32.000Z\\",\\"dateModified\\":1765448751000,\\"author\\":{\\"@type\\":\\"Person\\",\\"name\\":\\"PFinal南丞\\",\\"url\\":\\"https://friday-go.icu/about\\"},\\"publisher\\":{\\"@type\\":\\"Organization\\",\\"name\\":\\"PFinalClub\\",\\"logo\\":{\\"@type\\":\\"ImageObject\\",\\"url\\":\\"https://friday-go.icu/logo.png\\"}},\\"description\\":\\"详细介绍MySQL配置文件的解析，包括配置文件的位置、常用配置项、优化建议等，帮助开发者更好地管理和优化MySQL数据库。\\",\\"inLanguage\\":\\"zh-CN\\",\\"mainEntityOfPage\\":{\\"@type\\":\\"WebPage\\",\\"@id\\":\\"https://friday-go.icu/dev/system/database/MySQL-Configuration-Analysis\\"},\\"keywords\\":\\"MySQL, 配置文件, 解析, 优化, 数据库, 配置, 管理, 优化建议, 配置文件解析, MySQL配置文件, MySQL配置\\"}"]]},"headers":[],"relativePath":"dev/system/database/MySQL-Configuration-Analysis.md","filePath":"dev/system/database/MySQL-Configuration-Analysis.md","lastUpdated":1765448751000}'),e={name:"dev/system/database/MySQL-Configuration-Analysis.md"};function i(c,s,t,o,_,r){return p(),a("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1649503892000"},s[0]||(s[0]=[l(`<h1 id="mysql配置文件解析" tabindex="-1">Mysql配置文件解析 <a class="header-anchor" href="#mysql配置文件解析" aria-label="Permalink to &quot;Mysql配置文件解析&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[client]    </span></span>
