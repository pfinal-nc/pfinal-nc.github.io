import{_ as n,c as a,o as p,a6 as l}from"./chunks/framework.V1MgpNK7.js";const d=JSON.parse('{"title":"MySQL配置文件解析","description":"详细介绍MySQL配置文件的解析，包括配置文件的位置、常用配置项、优化建议等，帮助开发者更好地管理和优化MySQL数据库。","frontmatter":{"title":"MySQL配置文件解析","date":"2022-04-09T11:31:32.000Z","tags":["MySQL"],"description":"详细介绍MySQL配置文件的解析，包括配置文件的位置、常用配置项、优化建议等，帮助开发者更好地管理和优化MySQL数据库。","author":"PFinal南丞","keywords":"MySQL, 配置文件, 解析, 优化, 数据库, 配置, 管理, 优化建议, 配置文件解析, MySQL配置文件, MySQL配置","head":[["meta",{"name":"keywords","content":"MySQL, 配置文件, 解析, 优化, 数据库, 配置, 管理, 优化建议, 配置文件解析, MySQL配置文件, MySQL配置,pfinalclub, git, gitsite, javascript, node, jquery, python, php, laravel, sql, database, linux, operating system, os, cpu, verilog, risc-v, bitcoin, ethereum, ai, 教程, 软件, 编程, 开发, 运维, 云计算, 网络, 互联网, 比特币, 以太坊, 操作系统, 智能合约, 数字货币, 爬虫, 逆向"}]]},"headers":[],"relativePath":"zh/数据库/MySQL配置文件解析.md","filePath":"zh/数据库/MySQL配置文件解析.md","lastUpdated":1752052166000}'),e={name:"zh/数据库/MySQL配置文件解析.md"};function i(c,s,t,o,_,r){return p(),a("div",{"data-pagefind-body":!0},s[0]||(s[0]=[l(`<h1 id="mysql配置文件解析" tabindex="-1">Mysql配置文件解析 <a class="header-anchor" href="#mysql配置文件解析" aria-label="Permalink to &quot;Mysql配置文件解析&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[client]    </span></span>
