import{_ as n,c as a,o as p,a6 as e}from"./chunks/framework.DFafSIgU.js";const m=JSON.parse('{"title":"Redis配置文件详解","description":"学习Redis配置文件","frontmatter":{"title":"Redis配置文件详解","date":"2020-06-09T11:31:32.000Z","tags":["Redis"],"description":"学习Redis配置文件","keywords":"Redis配置文件详解, 数据库, redis","author":"PFinal南丞","head":[["meta",{"name":"keywords","content":"Redis配置文件详解, 数据库, redis"}]]},"headers":[],"relativePath":"zh/php/Redis-Configuration-Guide.md","filePath":"zh/php/Redis-Configuration-Guide.md","lastUpdated":1762767083000}'),l={name:"zh/php/Redis-Configuration-Guide.md"};function i(t,s,o,c,r,d){return p(),a("div",{"data-pagefind-body":!0},s[0]||(s[0]=[e(`<h1 id="redis配置文件详解" tabindex="-1">Redis配置文件详解 <a class="header-anchor" href="#redis配置文件详解" aria-label="Permalink to &quot;Redis配置文件详解&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># Redis配置文件样例</span></span>
